...
export function withOrdersCalc(percentage){
    return function (acc, curr, i) {
        ...
        const estimated_profit = total_orders_value * percentage;
        const value_after_sell = (total_orders_value * percentage) + total_orders_value;
...
export function getEndingCalc(orders, percentage) {
